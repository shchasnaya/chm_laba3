...
public class Main extends Application implements EventHandler<ActionEvent> {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        methods.getItems().addAll("Simpson's method", "MonteCarlo`s method", "Rectangle's method", "Trapezoidal`s method");
        methods.setValue("Simpson's method");
        ...
        left.getChildren().addAll(arcsin, equally);

        VBox right = new VBox(15);
        right.getChildren().addAll(arccos, ixs);
    ...
    public void getMethod(ChoiceBox<String> methods) {
        ...
        if (method == "Simpson's method") {
            ...
            out.setText(" ");
            out.setText(Simpson.Simpson_method(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Double.parseDouble(precisionofmethod.getText())));
            Graph.show(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()));
        }
        if (method == "MonteCarlo`s method") {
            String function = enter.getText();
            out.setText(" ");
            out.setText(MonteCarlo.MonteCarlo(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Double.parseDouble(precisionofmethod.getText())));
            Graph.show(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()));
        }
        if (method == "Rectangle's method") {
            String function = enter.getText();
            out.setText(" ");
            out.setText(rectangle.rectangle_method(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Double.parseDouble(precisionofmethod.getText())));
            Graph.show(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()));
        }
        if (method == "Trapezoidal`s method") {
            out.setText(" ");
            String function = enter.getText();
            out.setText(Trapezoidal.method(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()), Double.parseDouble(precisionofmethod.getText())));
            Graph.show(function, Double.parseDouble(limitA.getText()), Double.parseDouble(limitB.getText()));
        }
    }
}
